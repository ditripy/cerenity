...
import pennyImg from '../assets/cats/2.png';
      ...
      {gameState === 'success' && (
        <div className="game-modal success-modal">
          <div className="modal-content">
            ...
            <img src={pennyImg} alt="Penny the cat" style={{ width: '150px', height: '150px', objectFit: 'contain', margin: '1rem auto' }} />
            <p style={{ fontSize: '1.2rem', fontWeight: 'bold', color: '#5d4037' }}>You got Penny</p>
            <p>I'll help you budget your fish!</p>
